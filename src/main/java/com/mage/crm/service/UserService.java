...
public class UserService {
    ...
    public UserModel userLogin(String userName,String userPwd){
        ...
        AssertUtil.isTrue("0".equals(user.getIsValid()),"用户已销毁");
        /**
         * 获取用户权限  根据用户拥有的角色
         */
    ...
    public void updatePwd(String id,String oldPassword,String newPassword,String confirmPassword){
        ...
        AssertUtil.isTrue(oldPassword.equals(newPassword),"新密码不能与老密码相等");
    ...
    public Map<String,Object> queryUsersByParams(UserQuery userQuery) {
        ...
        PageInfo<Object> userDtoPageInfo = new PageInfo<>();
    ...
    private void relateRoles(List<Integer> roleIds,Integer userId) {
    ...
    public void update(User user) {
        ...
        AssertUtil.isTrue(tmpUser!=null&&user.getId().equals(tmpUser.getId()),"用户名称已经存在");
        AssertUtil.isTrue(userDao.update(user)<1,"用户数据更新失败");
