...
public class CustomerServeService {
    ...
    public void insert(CustomerServe customerServe) {
        checkCustomerServeParams(customerServe.getServeType(),customerServe.getCustomer(),customerServe.getServiceRequest());
    ...
    private void checkCustomerServeParams(String serveType,String customer,String serviceRequest) {
